...
_WCRTLINK extern grcolor
    _WCI86FAR _rgb2pixel(unsigned char, unsigned char, unsigned char);
_WCRTLINK extern void
    _WCI86FAR _pixel2rgb(unsigned char *, unsigned char *, unsigned char *, grcolor);
...
_WCRTLINK extern long
    _WCI86FAR _imagesize_wxy( struct _wxycoord _WCI86FAR *, struct _wxycoord _WCI86FAR * );

_WCRTLINK extern void
    _WCI86FAR _freeimage( char _WCI86HUGE * );
