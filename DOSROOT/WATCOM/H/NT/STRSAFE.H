                                 ...
                                 LPCSTR lpszSource, size_t cchMaxAppend )
{
    ...
    if( cchDestination > cchInit ) {
        strncat( lpszDestination, lpszSource,
             min( cchDestination - cchInit - 1, cchMaxAppend ) );
    }
                                  ...
                                  LPCSTR lpszSource, size_t cchSource )
{
    ...
    len = min( cchDestination - 1, cchSource );
    strncpy( lpszDestination, lpszSource, len );
    lpszDestination[len] = '\0';
    if( cchSource >= cchDestination ) {
        return( STRSAFE_E_INSUFFICIENT_BUFFER );
    } else {
        return( S_OK );
                                  ...
                                  LPCWSTR lpszSource, size_t cchSource )
{
    ...
    len = min( cchDestination - 1, cchSource );
    wcsncpy( lpszDestination, lpszSource, len );
    lpszDestination[len] = '\0';
    if( cchSource >= cchDestination ) {
        return( STRSAFE_E_INSUFFICIENT_BUFFER );
    } else {
