...
#define IN_CLASSA(__a)          ((((uint32_t)(__a)) & 0x80000000UL) == 0)
#define IN_CLASSA_NET           0xff000000UL
#define IN_CLASSA_NSHIFT        24
#define IN_CLASSA_HOST          (0xffffffffUL & ~IN_CLASSA_NET)
#define IN_CLASSA_MAX           128

#define IN_CLASSB(__a)          ((((uint32_t)(__a)) & 0xc0000000UL) == 0x80000000UL)
#define IN_CLASSB_NET           0xffff0000UL
#define IN_CLASSB_NSHIFT        16
#define IN_CLASSB_HOST          (0xffffffffUL & ~IN_CLASSB_NET)
#define IN_CLASSB_MAX           65536

#define IN_CLASSC(__a)          ((((uint32_t)(__a)) & 0xe0000000UL) == 0xc0000000UL)
#define IN_CLASSC_NET           0xffffff00UL
#define IN_CLASSC_NSHIFT        8
#define IN_CLASSC_HOST          (0xffffffffUL & ~IN_CLASSC_NET)

#define IN_CLASSD(__a)          ((((uint32_t)(__a)) & 0xf0000000UL) == 0xe0000000UL)
#define IN_MULTICAST(__a)       IN_CLASSD(__a)

#define IN_EXPERIMENTAL(__a)    ((((uint32_t)(__a)) & 0xe0000000UL) == 0xe0000000UL)
#define IN_BADCLASS(__a)        ((((uint32_t)(__a)) & 0xf0000000UL) == 0xf0000000UL)
...
_WCRTLINK extern unsigned short ntohs(unsigned short __netshort);
