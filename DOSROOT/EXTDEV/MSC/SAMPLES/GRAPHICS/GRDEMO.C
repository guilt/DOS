...
{                    /* Highlight Char  Pos */
    ...
    /* Warning: The following values are commented out because using
     * them with some monitors may damage the monitor. Make sure you
     * have adequate hardware before experimenting with them.
     */

    /* Uncomment if you have a NEC MultiSync 3D monitor or equivalent. */
//  { 0, "SRES16COLOR"  },  /* S     0  */
//  { 1, "SRES256COLOR" },  /* R     1  */

    /* Uncomment if you have a NEC MultiSync 4D monitor or equivalent. */
//  { 0, "XRES16COLOR"  },  /* X     0  */
//  { 5, "XRES256COLOR" },  /* 5     5  */

    /* Uncomment if you have a NEC MultiSync 5D monitor or equivalent. */
//  { 0, "ZRES16COLOR"  },      /* Z     0  */
//  { 9, "ZRES256COLOR" },      /* L     9  */
    { 0, ""             }
};
